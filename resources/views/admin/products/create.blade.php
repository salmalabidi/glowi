        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group" style="margin-bottom:0">
                    ...
                    <input type="number" name="price" step="0.01" min="0" class="form-input" value="{{ old('price') }}" required>
                    @error('price') <div class="form-error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group" style="margin-bottom:0">
                    <label class="form-label">Stock *</label>
                    <input type="number" name="stock" min="0" class="form-input" value="{{ old('stock', 0) }}" required>
            ...
            <div class="form-row" style="margin-top:22px">
                ...
                <div class="form-group" style="margin-bottom:0">
                    ...
                    <input type="text" name="product_type" class="form-input" value="{{ old('product_type') }}">
                </div>
            </div>
            ...
            <button type="submit" class="btn-submit">Créer le produit</button>
        </form>
    </div>
</div>
@endsection
