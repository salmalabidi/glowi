    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #cursor-ring {
            width: 32px;
            height: 32px;
            border: 1px solid rgba(200,116,138,0.5);
            border-radius: 50%;
            position: fixed;
            top: 0;
            left: 0;
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 12px 32px rgba(200,116,138,0.4);
        }
...
<body>
    ...
    <div class="page">
        <div class="brand-side">
            ...
            <p class="brand-desc">
                Rejoignez la communauté Glowi et accédez à une sélection exclusive de produits skincare et maquillage de prestige.
            </p>
        ...
        <div class="form-side">
            <div class="form-container">
                <div class="tab-switch">
                    <button type="button" class="tab-btn {{ $mode === 'login' ? 'active' : '' }}" onclick="switchTab('login')" id="tab-login">
                        Connexion
                    </button>
                    <button type="button" class="tab-btn {{ $mode === 'register' ? 'active' : '' }}" onclick="switchTab('register')" id="tab-register">
                        Créer un compte
                    </button>
                </div>
                ...
                <div class="auth-form {{ $mode === 'login' ? 'active' : '' }}" id="form-login">
                    ...
                    <div class="switch-mode">
                        ...
                        <button type="button" onclick="switchTab('register')">Créer un compte</button>
                    </div>
                </div>
