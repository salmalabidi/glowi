...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-logo::before {
            content: '•'; color: var(--rose); margin-right: 6px; font-size: 0.7rem;
        }
        .nav-center {
        ...
        .cart-badge {
            ...
            background: var(--rose);
            color: #fff; font-size: 0.6rem; font-weight: 500;
        ...
        .btn-connexion:hover { background: var(--rose-deep); transform: translateY(-1px); }
        ...
        .user-dropdown a:hover, .user-dropdown button:hover { color: var(--gold); }
        ...
        .footer-brand p {
            color: rgba(255,255,255,0.45); font-size: 0.8rem; line-height: 1.7;
        }
        .footer-col h4 {
            color: var(--gold);
        ...
        .marquee-inner span {
            color: #fff; font-size: 0.65rem; letter-spacing: 0.25em;
...
<body>
    ...
    <div class="marquee-bar">
        <div class="marquee-inner">
            @php $items = ['Skincare de Prestige','Maquillage Raffiné','Accessoires Curatés','Beauté Authentique','Glowi Paris','Livraison Offerte','Produits Sélectionnés','Skincare de Prestige','Maquillage Raffiné','Accessoires Curatés','Beauté Authentique','Glowi Paris','Livraison Offerte','Produits Sélectionnés']; @endphp
